...
export const CAR_UNLOCK_RULES = {
  /* 开局即解锁 */
  coupe:           { textKey: 'carUnlockDefault', default: true },
  tractor:         { textKey: 'carUnlockDefault', default: true },
  tricycle:        { textKey: 'carUnlockDefault', default: true },
  bullet_train:    { textKey: 'carUnlockDefault', default: true },
  bumper_car:      { textKey: 'carUnlockDefault', default: true },
  crystal_rainbow: { textKey: 'carUnlockDefault', default: true },
  ...
  zombie_car: { textKey: 'carUnlockZombieCar',  check: () => (progress.infiniteBest || 0) >= 27 },
  pirate_ship:{ textKey: 'carUnlockPirateShip', check: () => (progress.infiniteBest || 0) >= 29 },
  cat_car:    { textKey: 'carUnlockCatCar',     check: () => (progress.infiniteBest || 0) >= 30 },
};
...
export function getNewlyUnlockedCars() {
  ...
  for (const id of Object.keys(CAR_UNLOCK_RULES)) {
    if (CAR_UNLOCK_RULES[id].default) continue;
